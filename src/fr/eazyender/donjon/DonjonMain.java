		...
		new BukkitRunnable() {
			...
			public void run() {
				try {
					...
					Object header1 = new ChatComponentText("ß4ßlDonjon \nß7Dawn Network\nß7-------------------"); 
					Object header2 = new ChatComponentText("ß4ßlDonjon \nß7By Eazy_Ender\nß7-------------------");
					Object footer = new ChatComponentText("ßrß7-------------------\n"
							+ "ßrß4ßlInformations\n"
							//+ "ßeArgent : ß6" + PlayerEconomy.getPlayerEconomy().getMoney(ps) + "\n"
							+ "ß7Donjons ßflanc√©s : ßc" + DonjonGenerator.donjons.size() + "\n"
							+ "ßrß7-------------------\n"
							+ "ßrß7Joueursßf en ligne : ßc " + Bukkit.getServer().getOnlinePlayers().size()
							+ "\nßrßfVersion : ßcAlpha 1.0");
					if(tc) {
