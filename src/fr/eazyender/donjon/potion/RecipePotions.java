...
public class RecipePotions {
	...
	public static void initRecipes() {
		...
		small_heal_ingredients.add(RessourceUtils.getRessourceById(1));
		...
		small_heal_ingredients.add(RessourceUtils.getRessourceById(2));
		...
		small_speed_ingredients.add(RessourceUtils.getRessourceById(1));
